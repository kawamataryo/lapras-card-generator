  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="absolute z-10 mt-5 right-0 top-[27px]">
        <ul className="bg-base-200 p-2 rounded-md border border-gray-600 drop-shadow-sm w-[180px]">
          ...
          <li className="text-xs p-1 cursor-pointer flex gap-2 hover:bg-gray-700 rounded-md" onClick={copyActionsParam}>
          ...
          <li className="text-xs p-1 cursor-pointer flex gap-2 hover:bg-gray-700 rounded-md" onClick={shareOnTwitter}>
